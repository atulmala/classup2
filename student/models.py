...
class Student(models.Model):
    student_erp_id = models.CharField(max_length=20, null=True, blank=True, unique=True, db_column='student_erp_id') # this can be existing id such as registration number
