...
@csrf_exempt
def attendance_taken(request, the_class, section, subject, d, m, y, teacher):
            ...
            if q.count() == 0:
                ...
                if subject != 'Main' and subject != 'main' and subject != 'MAIN':
                    ...
                    try:
                        ...
                        if q.count() == 0:
                            print 'this student was not absent in Main attendance. Looks he has bunked this class...'
...
@csrf_exempt
def process_attendance1(request, the_class, section, subject, d, m, y, teacher):
    response_data = {
...
# we will implement authentication
@csrf_exempt
def delete_attendance2(request, the_class, section, subject, d, m, y):
    response_data   = {
